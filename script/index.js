...
const userNameInput = document.querySelector('.profile-form__input__name');
const userCareerInput = document.querySelector('.profile-form__input__career');
...
const cardName = document.querySelector('.card-creator__input__name');
const cardLink = document.querySelector('.card-creator__input__link');
